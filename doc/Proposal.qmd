...
1.  Partiendo de la formulación de cada modelo (E1.1), se aplicará el método de cálculo del punto de máxima pendiente [@reckase1985, @reckase1991] para obtener los parámetros de dificultad y discriminación de los ítems según cada uno de los modelos bajo estudio.
...
2.  Se investigará asimismo la aplicación de estos métodos al dominio de los modelos semiparamétricos y no paramétricos (E1.2), partiendo de la abstracción de los resultados anteriores y la generalización de los métodos aplicados en el objetivo E1.1.

3.  Aplicando la geometría euclidea, se obtendrán las representaciones gráficas vectoriales de los ítems, de acuerdo a los diferentes modelos, en coordenadas oblicuas, ya sea en dos (E2.1) o en tres (E2.2) dimensiones.
...
5.  Se realizarán estudios de simulación para la generación de ítems y respuestas en función de cada uno de los modelos multidimensionales bajo estudio (E3.1).
...
6.  Para ejemplificar la aplicación y utilidad práctica de las definiciones propuestas de los parámetros (E3.2), se realizará una búsqueda bibliográfica sistemática en la literatura sobre medición psicológica y educativa.
