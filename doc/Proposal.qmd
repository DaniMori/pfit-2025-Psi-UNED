...
4.  La representación gráfica se implementará en R [@rcoreteam2022], utilizando el paquete {ggplot2} [@wickham2011] para la representación bidimensional, y el paquete {plotly} [@sievert] para la representación en tres dimensiones.

5.  Se realizarán estudios de simulación para la generación de ítems y respuestas en función de cada uno de los modelos multidimensionales bajo estudio (O3.1).
...
6.  Para ejemplificar la aplicación y utilidad práctica de las definiciones propuestas de los parámetros (O3.2), se realizará una búsqueda bibliográfica sistemática en la literatura sobre medición psicológica y educativa.
...
![Planificación de alto nivel del proyecto CaMMTRIP](../www/Gantt_CaMMTRIP.png){fig-alt="Un diagrama de Gantt con el desglose de las tareas del proyecto" fig-align="center"}
